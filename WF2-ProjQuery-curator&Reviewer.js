...
describe('Workbench login and Dashboard',function()
{
    ...
    {
        cy.intercept('workbench/formMetadata/tasks/279729/entities/148/eavobjects?projectId=210&projectDataId=1532&tabDataImport=false&stateTypeId=1')
            .as('XRT')
    ...
    it.skip('Reviewer send task AR',function(){
        cy.Signin(CREDENTIALS.User2,CREDENTIALS.Pwd)
        Cypress.on('uncaught:exception', (err, runnable) => { return false; });
        cy.contains('Automation Project').click().should('have.text','Automation Project       ')
