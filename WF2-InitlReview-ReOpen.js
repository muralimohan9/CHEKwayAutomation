...
describe('Workbench login and Dashboard',function()
{
    ...
    it.skip('WF2-Initial Reviewer Login/Reassign',function(){
    ...
    it.skip('curator Resubmit to Reviewer',function(){
        cy.intercept('/workbench/formMetadata/tasks/278933/entities/148/eavobjects?projectId=210&projectDataId=1532&tabDataImport=false&stateTypeId=1')
            .as('XRT1')
        cy.User1(CREDENTIALS.User1,CREDENTIALS.Pwd)
        ...
        cy.get(':nth-child(3) > .nav-link > span').click({force:true})
        cy.contains('Automation Project').click({force:true}).should('include.text','Automation Project')
        cy.get('#react-tabs-26').click().should('have.text','Query Tasks')
        ...
        cy.get('#react-tabs-30').click().should('include.text','XRT1')
        // cy.wait('@XRT1')
        cy.get('#react-tabs-58').click().should('include.text','Queries ')
    ...
    it.skip('WF2-Initial Reviewer Resolve query',function(){
        cy.User2(CREDENTIALS.User2,CREDENTIALS.Pwd)
        cy.contains('TestWF3').click()
        cy.wait(2000)
        cy.get(':nth-child(3) > .nav-link').click({force:true})
