...
{
    it.skip('Lead Assign user',function(){
        cy.Workflow3_UserAssign()
    })
    it.skip('Workflow-3', function(){
        cy.Workflow3()
    })
    it.skip('Workflow-3/Reviewer', function(){
        cy.Workflow3_Reviewer()
    })
    it.skip('Workflow-3/Lead', function(){
        cy.Workflow3_Lead()
    })
    it.skip('TSD ReOpen / Workflow-3', function(){
    ...
    {
        cy.Lead(CREDENTIALS.User2,CREDENTIALS.Pwd)
        cy.intercept('/workbench/dashboard/getEavEntityByTaskId?taskId=280758&projectId=210&cohortName=CypCohort').as('gEBT')
    ...
    it.skip('Lead Query Reply',function()
    {
        ...
        cy.get('[type="submit"]').click({force:true})
        cy.on('window:alert', (str) => {
            expect(str).to.equal('The task will be moved to Active Review.')
        })
    })
    it.skip('Admin Query resolve', function(){
        cy.Signin(CREDENTIALS.Useradmin,CREDENTIALS.Pwd)
        cy.intercept('/workbench/dashboard/getEavEntityByTaskId?taskId=280758&projectId=210&cohortName=CypCohort').as('Task')
